...
func (m *MockSpreadsheet) ProcessValue(value any, format string, dataType DataType) (any, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSpreadsheetMockRecorder) ProcessValue(value, format, dataType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessValue", reflect.TypeOf((*MockSpreadsheet)(nil).ProcessValue), value, format, dataType)
}
