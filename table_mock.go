...
func (m *MockTableOperations) ProcessValue(value any, format string, dataType DataType) (any, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessValue", value, format, dataType)
	ret0, _ := ret[0].(any)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTableOperationsMockRecorder) ProcessValue(value, format, dataType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessValue", reflect.TypeOf((*MockTableOperations)(nil).ProcessValue), value, format, dataType)
}
